...
namespace Babylon::Polyfills::Internal
{
    ...
    void Context::BindFillStyle(const Napi::CallbackInfo& info)
    {
        ...
        {
            CanvasGradient* gradient = CanvasGradient::TryUnwrap(info.Env(), std::get<GradientStyle>(m_fillStyle)->Value());
            if (gradient == nullptr)
            {
    ...
    void Context::BindStrokeStyle(const Napi::CallbackInfo& info)
    {
        ...
        {
            CanvasGradient* gradient = CanvasGradient::TryUnwrap(info.Env(), std::get<GradientStyle>(m_strokeStyle)->Value());
            if (gradient == nullptr)
            {
